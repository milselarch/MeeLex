...
class TransferConfig(object):
    def __init__(self,
        ...
        :param max_io_queue_size: The maximum amount of readCredentials parts that
        ...
        :param num_download_attempts: The number of download attempts that
            ...
            down the data from s3 (i.e. socket errors and readCredentials timeouts that
        ...
        :param max_in_memory_upload_chunks: The number of chunks that can
            ...
            be waiting with a single readCredentials chunk to be submitted for upload
